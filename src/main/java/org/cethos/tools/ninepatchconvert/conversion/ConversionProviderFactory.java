...
import org.cethos.tools.ninepatchconvert.conversion.argumenthandler.SingleImageArgumentHandler;
...
public class ConversionProviderFactory
{
    ...
    private static final String CMD_LINE_SYNTAX = "ninepatch-convert [-s] [OPTIONS]";
